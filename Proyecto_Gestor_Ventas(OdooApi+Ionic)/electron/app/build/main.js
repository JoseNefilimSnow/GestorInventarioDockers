...
SalesInvoicePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-sales-invoice',template:/*ion-inline-start:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\sales-invoice\sales-invoice.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-buttons start>\n\n      <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>\n\n      Facturas\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-list no-lines [virtualScroll]="accountArray">\n\n    <ion-item-sliding *virtualItem="let accountArray; let i=index">\n\n      <ion-item (click)="view(i)">\n\n        <h2>{{accountArray.number}}</h2>\n\n      </ion-item>\n\n    </ion-item-sliding>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\sales-invoice\sales-invoice.html"*/,
    }),
...
TransfersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-transfers',template:/*ion-inline-start:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\transfers\transfers.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-buttons start>\n\n      <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>\n\n      Transferencias\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-list no-lines [virtualScroll]="transfArray">\n\n    <ion-item-sliding *virtualItem="let transfArray; let i=index">\n\n      <ion-item (click)="view(i)">\n\n        <h2>{{transfArray.reference}}</h2>\n\n        <p>{{transfArray.origin}}</p>\n\n      </ion-item>\n\n    </ion-item-sliding>\n\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\transfers\transfers.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__services_odoojsonrpc__["a" /* OdooJsonRpc */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_network__["a" /* Network */], __WEBPACK_IMPORTED_MODULE_2__services_utils__["a" /* Utils */]])
], TransfersPage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\app\app.html"*/'<ion-menu [content]="content">\n\n    <ion-header>\n\n      <ion-toolbar>\n\n        <ion-title>Menu</ion-title>\n\n      </ion-toolbar>\n\n    </ion-header>\n\n  \n\n    <ion-content>\n\n      <ion-list>\n\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n          {{p.title}}\n\n        </button>\n\n      </ion-list>\n\n      <ion-buttons end>\n\n          <button ion-button icon-only (click)="logOut()">\n\n            Cerrar Sesión\n\n            <ion-icon name="log-out"></ion-icon>\n\n          </button>\n\n        </ion-buttons>\n\n    </ion-content>\n\n  \n\n  </ion-menu>\n\n  \n\n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n\n  '/*ion-inline-end:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\app\app.html"*/,
...
ClientsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-clients',template:/*ion-inline-start:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\clients\clients.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-buttons start>\n\n      <button ion-button menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>\n\n      Clientes\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <form (ngSubmit)="checkUser()">\n\n    <ion-item class="border-box">\n\n      <ion-input type="text" placeholder="NIF/DNI" [(ngModel)]="Nif" name="Nif" required></ion-input>\n\n    </ion-item>\n\n    <div class="spacer" style="height: 10px;"></div>\n\n    <button ion-button block round outline type="submit">\n\n      Comprobar\n\n    </button>\n\n  </form>\n\n  <ion-list no-lines [virtualScroll]="clients">\n\n    <ion-item-sliding *virtualItem="let clients; let i=index">\n\n      <ion-item (click)="view(i)">\n\n        <h2>{{clients.name}}</h2>\n\n        <p>{{clients.vat}}</p>\n\n      </ion-item>\n\n    </ion-item-sliding>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\JoseDV\Desktop\Proyecto_Gestor_Ventas(OdooApi+Ionic)\src\pages\clients\clients.html"*/,
    }),
